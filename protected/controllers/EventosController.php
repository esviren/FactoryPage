...
class EventosController extends Controller
{
	...
	{
		return Yii::app()->Rules->getRules("Eventos");
	}
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Eventos']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->eveId));
		}
	...
	public function actionSeleccion()
	{
		...
		$id = $_POST['Eventos']['eveDepartamento'];
		$lista = Municipio::model()->findAll('dep_codigo = :id',array(':id'=>$id));
